              ...
              <div class="row">
                <div class="col-md-12 from-group">
                  ...
                  <select v-model="userData.selectedCity" class="form-control">
                    ...
                    v-for="city in userData.cities" v-bind:key="city.id"> {{ city }} </option>
                  </select>
                </div>
              </div>
              <div class="row">
      ...
      <div class="col-md-6" v-if="isSubmitted">
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <ul>
                <li v-for="item in userData.interests" v-bind:key="item.id">{{ item }}</li>
              </ul>
    ...
    data(){
      return {
        userData : {
          ...
          interests: [],
          gender:'',
          cities:["Istanbul", " Ankara", "Izmir", "Adana"],
          selectedCity: ''
        },
        switched: true,
        isSubmitted:false
